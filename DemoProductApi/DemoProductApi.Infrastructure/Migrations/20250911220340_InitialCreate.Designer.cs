...
namespace DemoProductApi.Infrastructure.Migrations
{
    ...
    [Migration("20250911220340_InitialCreate")]
            ...
            modelBuilder.Entity("DemoProductApi.Domain.Entities.BundleItem", b =>
                {
                    ...
                    b.HasIndex("BundleId", "ChildBundleId")
                        .IsUnique()
                        .HasFilter("\"ChildBundleId\" IS NOT NULL");

                    b.HasIndex("BundleId", "ChildProductItemId")
                        .IsUnique()
                        .HasFilter("\"ChildProductItemId\" IS NOT NULL");

                    b.ToTable("BundleItems", t =>
                        {
                            t.HasCheckConstraint("CK_BundleItem_ExactlyOneChild", "(CASE WHEN \"ChildProductItemId\" IS NOT NULL THEN 1 ELSE 0 END +  CASE WHEN \"ChildBundleId\" IS NOT NULL THEN 1 ELSE 0 END) = 1");
                        });
                });
            ...
            modelBuilder.Entity("DemoProductApi.Domain.Entities.BundleItem", b =>
                {
                    ...
                    b.HasOne("DemoProductApi.Domain.Entities.Bundle", "ChildBundle")
                        .WithMany()
