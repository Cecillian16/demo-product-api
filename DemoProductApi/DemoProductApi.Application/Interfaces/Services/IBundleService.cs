...
public interface IBundleService
{
    ...
    Task<BundleDto?> GetByIdAsync(Guid id, CancellationToken ct = default);
    Task<BundleDto> CreateAsync(BundleCreateRequest request, CancellationToken ct = default);
    Task<List<BundleDto>> BulkCreateAsync(List<BundleCreateRequest> requests, CancellationToken ct = default);
